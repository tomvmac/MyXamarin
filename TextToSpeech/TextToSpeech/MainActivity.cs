...
namespace TextToSpeechDemo
{
    ...
    public class MainActivity : Activity, TextToSpeech.IOnInitListener
    {
		...
		protected override void OnCreate(Bundle bundle)
        {
			...
			var btnHideKeyboard = FindViewById<Button>(Resource.Id.btnHideKeyboard);
			...
			// hide keyboard
			btnHideKeyboard.Click += delegate {
				var imm = (InputMethodManager)btnHideKeyboard.Context.GetSystemService(Android.Content.Context.InputMethodService);
				var result = imm.HideSoftInputFromWindow(btnHideKeyboard.WindowToken, 0);
